...
describe('TodosComponent', () => {
  ...
  const getBigInput = () =>
    fixture.debugElement.query(By.css('axon-big-input'));
  ...
  const deleteDoneTodosBtn = () =>
    fixture.debugElement.query(
      By.css('axon-big-input-action[fontIcon="fa-trash"] > button')
    );

  const addTodoBtn = () =>
    fixture.debugElement.query(
      By.css('axon-big-input-action[fontIcon="fa-plus"] > button')
    );
