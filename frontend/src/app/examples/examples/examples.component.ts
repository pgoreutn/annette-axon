...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'axon.examples.menu.todos' },
    { link: 'stock-market', label: 'axon.examples.menu.stocks' },
    { link: 'theming', label: 'axon.examples.menu.theming' },
    { link: 'authenticated', label: 'axon.examples.menu.auth' }
  ];
